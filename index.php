		...
		<body>
			<div id = "body_autenticacao" class="body_autenticacao">
				...
				<div class="body_autenticacao_meio">
					<form id="autenticacao_form" method="POST" onsubmit="return validar()">
						<input type="text" name="usuario" id="autenticacaoUsuario"class="autenticacao_campo"  maxlength="11" placeholder="Usuário" 
							onfocus="focoUsuario()"><br>
						<input type="password" name="senha" id="autenticacaoSenha"class="autenticacao_campo" placeholder="Senha" maxlength="6"
							onfocus="focoSenha()"><br>
						<input type="submit" class="autenticacao_submit" value="Entrar">
					</form>
					<form id="novoCadastro_form" method="POST" onsubmit="return validar()">
						<input onfocus="focoNomePF()"id="cadastroNomePF" type="text" name="nome_pf" class="autenticacao_campo" placeholder="Nome"><br>
						<input onfocus="focoSobrenomePF()"id="cadastroSobrenomePF" type="text" name="sobrenome_pf" class="autenticacao_campo" placeholder="Sobrenome"><br>
						<input onfocus="focoEmail()"id="cadastroEmailPF" type="email" name="email_pf" class="autenticacao_campo" placeholder="E-mail"><br>
						<input onfocus="focoCadastroCPF()" id="cadastroUsuario" type="text" name="NovoUsuario" class="autenticacao_campo" maxlength="11" placeholder="CPF"><br>
						<input onfocus="focoCadastroSenha()"id="cadastroSenha" type="password" name="senha" class="autenticacao_campo" placeholder="Senha" maxlength="6"><br>
						<input type="submit" id="submit_cadastro" class="autenticacao_submit" value="Cadastro">
					</form>
					<form id="esqueciSenha_form" method="POST" onsubmit="return validar()">
						<input type="text" name="usuario" id="esqueciUsuario" class="autenticacao_campo" placeholder="CPF"  maxlength="11" autofocus><br>
						<input type="email" name="email" id="esqueciEmail"class="autenticacao_campo" placeholder="E-mail"><br>
						<input type="date" name="nascimento" id="esqueciNascimento"class="autenticacao_campo" placeholder="Data de Nascimento"><br>
